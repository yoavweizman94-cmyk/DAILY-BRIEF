...
לאימות: workflow `access-flow-check` (ידני בלבד — שולח מייל אמיתי). הוא
בודק שקלט פסול נדחה, שכל משתני הסביבה קיימים, ושקישור אישור מזויף או
חסר-חתימה נדחה. אומת מקצה לקצה ב-19/08/2026, כולל הגעת המייל לתיבה.
