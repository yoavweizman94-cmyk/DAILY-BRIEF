...
בנוסף לשלוש המהדורות רץ workflow שני, `maya-watch`, כל רבע שעה בימי המסחר
(**שני–שישי**, 08:00–19:45 — הבורסה עברה בינואר 2026 לשבוע מסחר ב'–ו'). הוא מזהה דיווחים חדשים במאיה, מוריד את **גוף
הדוח** (ה-htm לכותרת וה-PDF המצורף לתוכן — בת053 ובת930 ה-htm הוא דף שער
בלבד), ומסכם כל דיווח עם דירוג מהותיות 1–3, כיוון השפעה ונימוק.
